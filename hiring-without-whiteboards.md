...
## A - C
  ...
  - [Agência Enterprise Studio](https://ae.studio) | Remote / Los Angeles, CA / Florianópolis, Brasil | Codificação ao vivo de uma tarefa que você faria diariamente
  ...
  - [Ciência de Dados ASI](https://www.asidatascience.com/careers) | Londres, Reino Unido | Projeto para trabalhar em casa, questões técnicas gerais, programação em dupla com engenheiros
  ...
  - [Feixe Dental](https://jobs.lever.co/beam) | Colombo, OH / Remoto | Tela do telefone, projeto Take Home, emparelhamento presencial ou remoto e entrevista multifuncional
  ...
  - [Bônus](https://bonus.ly/careers) | Boulder, CO - Brasil | Entrevista focada em Valores e Tecnologia - Processo: 30 minutos com RH, entrevista Google Meet de 45 minutos com 2 membros da equipe, ~2-4 horas de projeto take-home, entrevista no local envolvendo 2 entrevistas de alinhamento de valores e 1 entrevista técnica abordando seu projeto take home
  ...
  - [Chef](https://www.chef.io/careers) | Seattle, WA / Remoto | Leve para casa pequenos projetos testando a capacidade de implementar problemas do mundo real. Entrevistas por telefone/Zoom discutindo o referido projeto. Verificar se o candidato seria um bom fit cultural.
  ...
  - [Combyne](https://combyne.com) - Brasil | Remote / Munique, Alemanha | Teste técnico on-line curto, projeto de 4 horas para levar para casa e entrevista de adequação cultural com os membros da equipe.
  ...
  - [Greve Coletiva](https://crowdstrike.wd5.myworkdayjobs.com/crowdstrikecareers) | Remoto | Várias entrevistas no local ou remotas, conforme apropriado, seguidas de um pequeno projeto de levar para casa.
...
## D - F
  ...
  - [Semente de Desenvolvimento](https://developmentseed.org/careers) | Remoto / Washington, DC / Lisboa, Portugal / Ayacucho, Peru | Discussão introdutória; entrevista técnica em vídeo em profundidade (sem quadro branco e sem codificação ao vivo); missão e valores entrevista em vídeo; no local (ou remoto) 1 ou 2 dias de trabalho remunerado "sprint" no contexto de um projeto real, culminando em uma breve apresentação do trabalho de sprint concluído
  ...
  - [E-sotaque](https://www.e-accent.com) | Hilversum, Holanda; Remoto | Conversa via Skype, atribuição para levar para casa
  ...
  - [Engel & Völkers Tecnologia](https://www.engelvoelkers.com/en/tech/) | Hamburgo, Alemanha | Entrevista técnica remota com um Gerente de Engenharia, seguida de um desafio prático de codificação implementado em 5 horas, terminando com uma discussão técnica com a equipe sobre o código produzido remotamente ou no local com base na praticidade geográfica.
  ...
  - [FastBill](https://www.fastbill.com/jobs) - Brasil | Frankfurt, Alemanha | Entrevista inicial via Skype/Zoom. Pequeno projeto tech-home baseado no trabalho específico. Posteriormente revisão de código e discussão técnica.
  ...
  - [Frappe](https://frappe.io/careers) - Brasil | Mumbai, Índia; Remoto | Projeto take-home, um pequeno exercício de programação em dupla, discussão e entrevista com membros da equipe de Engenharia.
...
## G - I
  ...
  - [GitHub](https://github.com/about/careers) - Brasil | Remoto; São Francisco, CA; Penedo, CO| Exercícios para levar para casa, revisão de código e discussões técnicas.
  ...
  - [Gráfico](http://www.graphicacy.com) | Washington, D.C. | Entrevista por telefone; entrevista presencial ou virtual, dependendo do local e disponibilidade; Dois breves trabalhos técnicos focados em flexibilidade, criatividade e competência geral
  ...
  - [A Heroku](https://heroku.com/careers) - Brasil | Remoto | Projeto independente timeboxed no Github, discussão/debriefing do projeto via Hangouts, discussão de produção via Hangouts, reunião "meet the team"
  ...
  - [iConstituinte](http://iconstituent.com/careers/) | Washington, D.C. | Projeto take-home e revisão de código pessoalmente
...
## J - L
  ...
  - [K Saúde](https://www.khealth.ai) | Tel Aviv, Israel | Triagem por telefone para discutir a formação técnica e a experiência anterior. Tarefa para levar para casa seguida de revisão de código no local e entrevista. Avaliação do fit cultural
  ...
  - [Landing.jobs](https://landing.jobs/at/landing-jobs) | Lisboa, Portugal | Entrevistas (presenciais ou remotas), projeto de codificação Take home
  ...
  - [Lob](https://lob.com/careers) | São Francisco, Califórnia | Tela inicial do telefone seguida de uma entrevista no local. Problemas técnicos discutidos durante a entrevista são todas versões simplificadas de problemas que tivemos que resolver na produção. Todo o nosso processo de entrevista e o que estamos procurando está descrito em nossa postagem no blog [How We Interview Engineers](https://lob.com/blog/how-we-interview-engineers).
  - [Locástico](https://www.locastic.com/posao) | Split, Croácia | Desafio de código take-home, discussão técnica e sessão de programação no local, encontro e cumprimentação com a equipe
  - [Locaweb](https://www.locaweb.com.br/carreira) - Brasil | São Paulo, Brasil | Entrevista via Skype, projeto take-home e discussão no local
  - [LOGIBALL GmbH](https://www.logiball.de/en/jobs/) - Brasil | Berlim, Hannover e Herne na Alemanha | Entrevistas e discussão
  - [Lógica Suave](https://logicsoft.co.in) | Chennai, Brasil | Discussão por telefone, exercício de programação em pares F2F + discussão
  - [LonRes](https://www.lonres.com/public/working-us) - Brasil | Londres, Reino Unido | Chamada de introdução rápida com tecnologia (Skype), tarefa de codificação por ≈1 hora, entrevista cara a cara (ou via Skype) e reunião com membros da equipe.
  - [LookBookHQ](https://www.pathfactory.com/careers/) - Brasil | Toronto, Canadá | Discussão no local, exercício de programação em pares
  - [Tear](https://www.useloom.com/careers) | São Francisco, Califórnia | O Google Hangouts retoma o mergulho na experiência passada, projeto de levar para casa OU tela arquitetônica do telefone, entrevistas no local (2 arquitetura técnica relacionada ao trabalho, 1 ou 2 não técnicas)
  - [Lovion GmbH](https://jobs.lovion.de) - Brasil | Dortmund, Alemanha | Entrevista presencial ou remota para adequação técnica e cultural
  - [Luna](https://oiluna.com) - Brasil | São Paulo, Brasil | Projeto e/ou discussão (presencial ou remoto)
  - [Lydia](https://lydia-app.com/en/company/jobs) - Brasil | Paris, França | Mini projeto take-home, entrevista por telefone, discussão no local
  - [Equipe móvel da Lyft](http://www.lyft.com/jobs) | São Francisco, CA; Ribeiro, WA; Nova Iorque, NY; Minsk, Bielorrússia; Cidade do México, México | Projeto no local, discussão do projeto concluído do candidato depois
  - [Lykon - Brasil](https://lykon.de) | Berlim, Alemanha | Entrevista por telefone seguida de tarefa em casa que reflete nosso trabalho diário e, em seguida, entrevista no local
  - [Lyoness Áustria GmbH](http://www.lyoness-corporate.com/de-AT/Karriere/Jobangebote) | Graz, Áustria | Projeto Take-Home, discussão no local

## M - O



  - [Tecnologia Made](https://www.madetech.com/careers) | Londres, Reino Unido | [Nosso processo de contratação](https://github.com/madetech/handbook/tree/master/guides/hiring#20-minute-phone-conversation)
  - [Mágico](https://magical.team/work) | Tel Aviv, Israel; Remoto | Entrevista de fit cultural + take home assignment, seguida de uma entrevista técnica e uma entrevista com o CTO.
  - [Magnetis](https://magnetis.workable.com) - Brasil | São Paulo, Brasil & Remoto | Entrevista por telefone + tarefa para casa, seguida de programação em dupla e reunião informal com a equipe.
  - [Liga Principal de Futebol](https://careers-mlssoccer.icims.com/jobs/search?ss=1&searchCategory=20285) | Nova Iorque, NY | Entrevista por telefone + projeto de levar para casa, que é focado no trabalho diário. A entrevista presencial pode envolver a discussão de projetos passados ou programação em duplas.
  - [MakeMusic](http://www.makemusic.com/careers/) - Brasil | Ribeiro, CO; Denver, CO - Brasil | Tela do telefone, projeto take home, entrevistas remotas e presenciais para adequação técnica e cultural
  - [MakeTime](https://maketime.workable.com) - Brasil | Lexington, KY - Brasil | Exercício prático e/ou uma sessão de emparelhamento no local
  - [Soluções Mango](http://www.mango-solutions.com/wp/about-mango/team) | Londres (Reino Unido), Chippenham (Reino Unido) | Entrevista inicial por telefone, seguida de entrevista in loco com atribuição para levar para casa
  - [Caixa de mapas](https://www.mapbox.com/jobs) | São Francisco, CA; Washington, DC; Ayacucho, Peru; Bangalore, Índia; Berlim, Alemanha; Remoto | Entrevistas conversacionais, projeto pago no local com equipe.
  - [Matéria](https://mattermost.com/careers/) | Remoto | Perguntas de acompanhamento por e-mail, algumas chamadas de vídeo, audição (projeto "experimentar" pago no mundo real), chamada de vídeo para discutir a audção e, em seguida, uma chamada de vídeo com o CTO
  - [Mavenlink](https://www.mavenlink.com/careers) - Brasil | São Francisco, CA; Ribeiro, A.C.; Cidade de Lago de Sal, UT | Emparelhamento no local com vários engenheiros. Exercícios de emparelhamento e emparelhamento no código da empresa.
  - [Maxwell Saúde](https://www.maxwellhealth.com/careers) | Boston, MA - Brasil | Leve para casa exercícios ou sessão de emparelhamento com a equipe. Em seguida, reuniões de conversação com membros da equipe.
  - [Me & Empresa](https://me-company.de/jobs/) | Düsseldorf, Alemanha | Você se junta a nós por um ou dois dias de teste pagos para trabalhar em uma tarefa e conhecer a equipe.
  - [MealMe](https://mealme.ai) - Brasil | São Francisco, Califórnia | Entrevista introdutória inicial, entrevista técnica de 1 hora com CTO (problema do mundo real), perguntas rápidas sobre pensar e trabalhar em uma start-up.
  - [Mídia Pop](https://mediapop.co) | Cingapura, Cingapura | Levar para casa ou não supervisionado (no local) atribuição do mundo real
  - [Meetrics](https://www.meetrics.com) | Berlim, Alemanha | Entrevista inicial, desafio de código take-home e revisão
  - [Água de fusão](http://underthehood.meltwater.com/jobs) | Manchester, NH | Pequeno exercício que será apresentado à equipe durante uma entrevista no estilo QA
  - [Menção](https://mention.workable.com) | Paris, França | Leve para casa pequenos exercícios seguidos de reuniões no local com seus futuros colegas de trabalho
  - [Mercado Livre](https://jobs.mercadolibre.com) | São Paulo, Brasil | Entrevista por telefone com o departamento de RH, projeto Takehome e discussão (presencial ou remota) com entrevista para avaliar a experiência anterior do candidato e entrevista Cultural Fit com um gestor.
  - [Mercatus](https://www.mercatus.com/company/careers) - Brasil | Toronto, Canadá | Projeto prático no local semelhante ao trabalho diário
  - [Mercados Metropolitanos](https://www.metro-markets.de/careers/) | Düsseldorf, Alemanha | Você pode nos conhecer participando de entrevistas totalmente remotas conosco ou você pode vir nos visitar no local
  - [mfind](https://www.mfind.pl/dolacz-do-nas/) - Brasil | Varsóvia, PL | Telefonema sobre experiência técnica, projeto Take-home ou teste técnico (depende da experiência), Entrevista no local com líder técnico.
  - [O miDrive](https://midrive.com/careers) | Londres, Reino Unido | Tela do telefone, projeto Take-home / teste técnico, Entrevista no local com sênior e pares.
  - [milch & zucker](https://www.milchundzucker.de) - Brasil | Gießen, Alemanha | Entrevista com feedback direto, candidatos fornecendo amostra de trabalho, revisão de código (código do produto ou código pessoal das aplicações)
  - [Mídia Minuto](http://www.minutemedia.com/careers/) | Tel-Aviv, Israel | Triagem telefônica com engenheiro. Perguntas de desafio do mundo real no local com dois engenheiros. Às vezes, uma atribuição para levar para casa ou um envio de exemplo de código existente.
  - [Miro](https://miro.com/careers/) - Brasil | Amsterdã, Holanda; Ribeiro, DE; Londres, Reino Unido | Compartilhe sua própria IDE e codifique nossa atribuição, em seus termos. Compartilhamos o problema com 24 horas de antecedência, mas pedimos que você configure o IDE apenas com antecedência, para que 100% da sua codificação aconteça durante a entrevista.
  - [Mirumee](https://mirumee.com/jobs) - Brasil | Wroclaw, Polônia; Remoto | Emparelhar programação e revisão de código usando um dos problemas (ou Pull Requests) em nosso projeto Saleor de código aberto, discussão geral sobre programação, tecnologia e experiência do candidato
  - [Mixmax](https://mixmax.com/careers) - Brasil | São Francisco, Califórnia | Atribuição de takehome puramente com base em sua plataforma, seguida de entrevista por telefone
  - [Realidade móvel](https://themobilereality.com/careers) | Varsóvia, Polônia | Entrevista com questões técnicas e tarefa prática para fazer em casa por 3-5 horas. O candidato tem liberdade em termos de ambiente e configuração do projeto. Depois de alguns dias o feedback chega por e-mail.
  - [MobileCashout](https://www.mobilecashout.com) | Barcelona, Espanha; Valência, Espanha | Chamada de vídeo de introdução rápida com uma tecnologia (menos de 10-15 minutos). Contribuição de código aberto no local para um projeto de escolha dos candidatos, emparelhado com uma tecnologia da equipe. Entrevista e um pequeno questionário sobre design de software e tecnologias relevantes. Entrevista e apresentação da empresa com um representante de RH.
  - [Pensamento móvel](https://mobilethinking.ch) | Genebra, Suíça | 1 hora de discussão sobre formação técnica e experiências passadas, preferencialmente presencial
  - [Modo](https://about.modeanalytics.com/careers) | São Francisco, Califórnia | Entrevista por telefone seguida de arquitetura de pares no local e discussão
  - [MokaHR](http://mokahr.com) - Brasil | Pequim, China | Leve para casa o projeto/desafio e, em seguida, a sessão de programação no local retirada de problemas que encontramos no trabalho
  - [Nuvem derretida](https://www.moltencloud.com) | São Paulo, MA; Remoto | Entrevista técnica, entrevista comportamental com CEO, desafio take-home projetado para espelhar problemas que a empresa encontra
  - [Equipe Web Front-end do Moneytree](https://moneytree.jp) | Tóquio, Japão | Exercício de programação em dupla e reunião social com a equipe
  - [Monite](https://monite.com) | Berlim, Alemanha | Entrevista de triagem com RH (expectativas salariais, planos de carreira), projeto de projeto arquitetônico (sem código) e entrevista técnica para discutir seu conjunto de habilidades + perguntas gerais
  - [Monzo - Brasil](https://monzo.com) | Londres, Reino Unido & Remote | Entrevista por telefone com outro engenheiro. Atribuição para levar para casa. Ligue para debriefing sobre a tarefa de levar para casa. Entrevista de meio dia (presencial ou Hangouts) com três sessões de conversação: (1) desenvolvimento de teste take-home e design de sistema do mundo real (verbal e colaborativo); (2) aprofundar o conhecimento e a compreensão em 1-2 outras áreas técnicas relevantes; (3) antecedentes gerais, equipes e formas de trabalho.
  - [Moteefe](https://www.moteefe.com/jobs) - Brasil | Londres, Reino Unido & Remote | Entrevista com CTO. Leve para casa projeto/desafio.
  - [A Mozilla](https://careers.mozilla.org/listings) | São Francisco, EUA; Portland, EUA; Toronta, Califórnia; Vancouver, Califórnia; Ribeiro, DE; Remoto | Discussões aprofundadas sobre problemas técnicos e de mentoria resolvidos no passado. Sem codificação ao vivo. Total de 3 rodadas.
  - [Mútuo Móvel](https://mutualmobile.com/careers) | São Paulo, RJ; Hyderabad, Brasil | Discussão técnica, teste de código com base no trabalho real que você fará, discussões de estilo de painel para multifuncional e adequação à cultura.
  - [Mutual de Omaha](http://www.mutualofomaha.com/careers) | Omaha, NE, Estados Unidos | Estilo Painel Entrevistas que analisam a resolução de problemas, a capacidade de se adaptar bem às mudanças e as habilidades de comunicação interpessoal.
  - [Software mutuamente humano](https://www.mutuallyhuman.com) | MI, OH, WA | Análise colaborativa de problemas e exercício de design, exercício de emparelhamento
  - [Mux](https://mux.com/jobs/) - Brasil | São Francisco, CA; Londres, Reino Unido & Remote | Entrevistas práticas de engenharia de software e design de sistemas que se concentram na construção colaborativa de aplicativos práticos em escala.
  - [Meu Táxi](https://mytaxi.com) | Hamburgo, Alemanha | Bate-papo por vídeo com RH, Take Home Assignment, Review of Assignment com um membro técnico, entrevista técnica e onboarding.
  - [MyHeritage](https://www.myheritage.com) - Brasil | Ou Yehuda, Israel; Kiev, Ucrânia | Videochamada com RH, teste de resolução de problemas em codility.com, chamada de vídeo com líder técnico e resolução de problema a partir de projeto real, entrevista de design de sistema no local.
  - [Meu Tutor](https://apply.workable.com/mytutor/) | Londres, Reino Unido | Faça um teste em casa, seguido de programação em duplas, discussão sobre design de sistemas e entrevista multifuncional no local
  - [Naológica](https://naologic.com/careers/jobs) | São Francisco, EUA | Atribuição de programação takehome e entrevistas pessoais com parte da equipe fundadora.
  - [Instrumentos Nativos](https://www.native-instruments.com) | Berlim, Alemanha | Atribuição de programação takehome e entrevistas pessoais com parte da equipe de contratação.
  - [Nearsoft Inc](https://nearsoft.com/join-us/) - Brasil | Hermosillo, México; Chihuahua, México; Cidade do México, México | [Teste de lógica](https://nearsoft.com/blog/the-logic-behind-nearsofts-logic-test/) Takehome, entrevista em inglês para verificar habilidades de comunicação, breve entrevista técnica sobre experiência, longa discussão técnica sobre linguagens/ferramentas/práticas que você usará diariamente, sessão de programação em par.
  - [Nedap](http://lifeatnedap.com/vacatures) - Brasil | Groenlo, Países Baixos / Remoto | Uma conversa simples, de humano para humano e um pequeno projeto no local
  - [Neotérico](https://neoteric.eu/career/) | Gdańsk, Varsóvia, Polônia; Remoto | Conversa Face2Face, leve para casa exercício e sessão de programação em pares
  - [NerdWallet](https://www.nerdwallet.com/careers) - Brasil | São Francisco, CA; Remoto | Revisão de código da tela do telefone, projeto no local para construir um aplicativo funcional com a plataforma de escolha do entrevistado
  - [Netguru](https://www.netguru.co/career) - Brasil | Varsóvia, Polônia; Remoto | Takehome exercício & sessão de programação em pares
  - [Negalês](https://www.netlandish.com) | Los Angeles, Califórnia; Remoto | Exercício para levar para casa, entrevista por chat, entrevista em vídeo
  - [Netlify](https://www.netlify.com/careers) | São Francisco, Califórnia / Remoto | Projeto Takehome e discussão on-line/no local
  - [Neulabs](https://neulabs.com/careers) - Brasil | Milão, Itália | Tela inicial do telefone com RH. Breve conversa com VP de Engenharia ou CTO. Pequeno projeto de take-home seguido de uma revisão técnica com 1 ou mais engenheiros e uma discussão de adequação à cultura.
  - [Laboratório Neural](https://neurallab.io) | Shatin, Hong Kong; Remoto | Entrevista on-line não técnica (comportamental), seguida de uma entrevista técnica com a equipe principal - principalmente girando em torno dos problemas do mundo real, melhores abordagens e algumas perguntas baseadas em cenários.
  - [Nova Relíquia](https://newrelic.com/about/careers) | São Francisco, Califórnia | Takehome exercício e / ou sessão de programação em dupla, dependendo da equipe
  - [Nova Loja](https://www.newstore.com/careers/) | Berlim, Alemanha; Hannover, Alemanha; Erfurt, Alemanha; Boston, MA - Brasil | Entrevista técnica por telefone, envio de amostra de código ou exercício de codificação takeaway, programação em pares no local, sessão de design (1/2 dia)
  - [NewVoiceMedia](https://www.newvoicemedia.com/about-newvoicemedia/careers) | Basingstoke, Inglaterra; Wroclaw, Polónia | Entrevista por telefone, exercício de codificação takeaway, programação em pares no local, revisão de código e discussão técnica (1/2 dia)
  - [Nexapp](https://nexapp.ca/career/) - Brasil | Cidade de Quebec, Canadá | Chamada de vídeo onde te conhecemos mais e você nos conhece mais, seguida de uma entrevista técnica por videochamada onde discutimos alguns problemas em aberto fortemente inspirados pelo trabalho diário do mundo real que fazemos.
  - [Nexcess.net](https://nexcess.net) | Southfield, MI - Brasil | Conversamos principalmente para ter uma ideia de ambas as pontas se houver um bom ajuste cultural. Fazemos perguntas para ver que experiência você tem e como você pensa como programador. Em algum momento, olhamos para alguns de seus códigos ou fazemos com que você trabalhe em alguns dos nossos (1 hora).
  - [Ágil](https://nimblehq.co) | Banguecoque, Tailândia; Cidade de Ho Chi Minh, Vietnã; Da Nang, Vietnã | Exercício de takehome e discussão de papéis específicos
  - [Ninjaneers](https://www.ninjaneers.de) | Kassel, Alemanha; Remoto | Google Hangouts retoma mergulho em experiências e projetos anteriores
  - [Niteoweb](http://www.niteoweb.com/careers) - Brasil | Liubliana, Eslovénia | Junte-se a nós por uma semana para ver se nos encaixamos
  - [Nitro](https://www.gonitro.com/about/jobs) | Dublin, Irlanda; São Francisco, Califórnia | Chamada telefônica, teste de take home, entrevista telefônica do gerente de contratação seguida de uma discussão no local
  - [Nmbrs](https://jobs.nmbrs.com) - Brasil | Amsterdã, Holanda; Lisboa, Portugal | Entrevista cultural, teste em casa, entrevista com CTO
  - [Noé](https://www.noa.one) - Brasil | Berlim, Alemanha; São Francisco, Califórnia | 1 bate-papo técnico, 2-3 bate-papos culturais com colegas de diferentes departamentos da equipe, se estes funcionarem um exercício de programação em pares
  - [NodeSource](http://nodesource.com/careers) | Remoto | Um passeio de pessoa para pessoa de um projeto passado seu
  - [Nomoko, câmera](https://www.nomoko.world/jobs) | Zurique, Suíça | Três interrogatórios
  - [Norbsoft](https://www.norbsoft.com/careers) - Brasil | Cracóvia, Polônia; Warszawa, Polônia; Sosnowiec, Polônia; Remoto | Envio de exercícios para levar para casa ou amostras de código, discussão técnica por videoconferência
  - [Nord Software](https://www.nordsoftware.com/en/jobs) | Helsínquia, Finlândia; Tampere, Finlândia; Estocolmo, Suécia | Take-home exercício e entrevista com CEO e desenvolvedor sênior
  - [NordPass](https://nordsecurity.com/careers) | Remoto | Palestra de RH, tarefa de levar para casa, entrevista de tecnologia, entrevista de fit cultural
  - [NoRedInk](https://www.noredink.com/jobs) - Brasil | São Francisco, Califórnia | Take-home exercício & sessão de programação em pares
  - [Nova Cuidados](https://www.novacare.no) | Oslo, Noruega | Entrevista casual, exercício para levar para casa e apresentação
  - [Nova Crédito](https://www.novacredit.com/careers) | São Francisco, Califórnia | Escolha entre uma tarefa levar para casa ou duas entrevistas no CoderPad, CodePen ou seu dev env local durante o compartilhamento de tela. A rodada final está trabalhando no local em um pequeno projeto
  - [NoviCap](https://novicap.com/en/careers.html) - Brasil | Barcelona, Espanha | Takehome exercício e discussão no local
  - [Novoda](https://novoda.com/joinus) - Brasil | Londres, Reino Unido; Liverpool, Reino Unido; Berlim, Alemanha; Barcelona, Espanha; Remoto | 2 x Sessões de emparelhamento e entrevistas conversacionais [(repositório público)](https://github.com/novoda/dojos)
  - [Parceiros Novus](https://www.novus.com/jobs) | Nova Iorque, NY | Exercícios para levar para casa e exercícios no local (escolha de laptop ou quadro branco)
  - [Noyo](https://www.noyo.com/careers/) - Brasil | São Francisco, CA / Durham, NC / Remoto | Entrevista por telefone, tarefa para levar para casa, revisão de código no local e percorrer um projeto passado do qual você se orgulha
  - [Nozbe](https://nozbe.com/careers) - Brasil | Remoto | Take-home exercício e entrevista com a equipe
  - [npm, Inc](https://npmjs.com/jobs) - Brasil | Oakland, Califórnia / Remoto | Sem desafios técnicos. Basta entrevistar conversas.
  - [Nubank](https://nubank.workable.com) - Brasil | São Paulo, Brasil | Conversa por telefone, exercício para levar para casa, passo a passo de código, emparelhamento de código no local.
  - [numeração](https://www.numberly.com) | Paris, França | Série de entrevistas, que abordam formação técnica, experiências passadas e conhecimentos culturais
  - [numer.ai](https://angel.co/numerai/jobs) | São Francisco, Califórnia
  - [Nurx](https://www.nurx.com/technology/) - Brasil | São Francisco, CA; Remoto | Tela do telefone com recrutador e/ou gerente de contratação, avaliação técnica com várias opções (full take home, partial take home, no take home) e, em seguida, virtual no local com uma sessão de codificação em par, revisão por pares de um documento técnico, design de arquitetura e loop executivo
  - [Casca de noz](https://www.nutshell.com/jobs) | Ann Arbor, MI, EUA | Tela de e-mail / exercício de programação take-home ([repositório público](https://github.com/nutshellcrm/join-the-team))
  - [Nyon - Brasil](https://www.nyon.nl/jobs) | Amesterdão, Países Baixos | 1. Entrevista via Skype (ou na vida real) 2. Leve para casa exercício (3-4 horas) 3. Conheça toda a equipe e emparelhe sessões de programação
  - [O'Reilly Mídia](https://oreilly.com/jobs) | Sebastopol, CA; São Paulo, MA; Remoto | Conversa por telefone, sessão de exercícios para levar para casa ou programação em dupla, entrevista em equipe, tudo via Google Hangout
  - [Oak Street Saúde](https://www.oakstreethealth.com/careers) | Chicago, IL / Remoto | Casual, mas semi-técnico tela inicial do telefone. Uma chamada de vídeo de uma hora consistindo em uma discussão técnica aprofundada com os desenvolvedores líderes, seguida por uma hora de discussão com a equipe do produto
  - [Object Partners, Inc.](https://objectpartners.com/careers/) | Minneapolis, MN; Omaha, NE | Entrevista por telefone para avaliar o interesse mútuo, seguida de uma entrevista técnica um pouco mais aprofundada
  - [Objetivo, Inc.](https://www.objectiveinc.com/careers) | Cidade de Lago de Sal, UT | Leve para casa o exercício de programação e, em seguida, converse amigável no local com a equipe
  - [Tecnologia OCTO](http://rejoins.octo.com) | Paris, França | Entrevista de RH para repassar suas experiências e conhecimentos culturais. Em seguida, uma discussão mais ou menos informal com dois futuros membros da equipe sobre design de arquitetura, práticas ágeis, projeto take-home, programação em par...
  - [Octopus Energia](https://octopus.energy/careers/) | Londres, Reino Unido; Sydney, Austrália; Remoto | Exercício para levar para casa e entrevista/discussão por telefone ou no local com a equipe em potencial
  - [Oda](https://careers.oda.com/jobs) - Brasil | Oslo, Noruega; Helsínquia, Finlândia; Berlim, Alemanha | Triagem por telefone para discutir a formação técnica e a experiência anterior. Tarefa para levar para casa seguida de discussão virtual do projeto e entrevista. Avaliação do fit cultural.
  - [Odeko](https://grnh.se/e9ddbe544us) - Brasil | Remoto; Nova Iorque, NY; Dublin, IE | Projeto take-home (2 horas) relacionado à função, entrevista técnica de acompanhamento onde você discute a implementação do seu projeto (pode realizar sessão de programação em pares em vez de entrevista técnica).
  - [Olist](https://olist.com) | Curitiba, Brasil | Projeto take-home e entrevistas remotas ou presenciais
  - [Omada Saúde](https://www.omadahealth.com/jobs) | São Francisco, Califórnia | Leve para casa exercícios e/ou sessões de programação em duplas.
  - [Oncue](http://oncue.co) - Brasil | São Francisco, CA; Remoto | Teste de codificação on-line sobre problemas do mundo real (2 horas). Discussão técnica com equipe de desenvolvedores.
  - [OneMain Financeira](https://jobs.onemainfinancial.com) | São Paulo, IL; Remoto | Exercício para levar para casa e entrevista/discussão no local com a equipe em potencial
  - [OneSignal](https://onesignal.com/careers) - Brasil | San Mateo, Califórnia | Chamada de introdução com recrutamento, segunda conversa com o engenheiro do OneSignal, emparelhamento no local via compartilhamento de tela
  - [Onfido](https://onfido.com/jobs) - Brasil | Londres, Reino Unido; Lisboa, Portugal | Exercício para levar para casa e entrevista/discussão no local com a equipe em potencial
  - [Ontame.io](https://ontame.io) | Copenhaga, Dinamarca | Leve para casa exercícios e discussões específicas de papéis
  - [Opbeat](https://opbeat.com/jobs#seniorbackendengineer) - Brasil | Copenhaga, Dinamarca | Emparelhamento em um problema do mundo real
  - [Base aberta](https://angel.co/company/openbasecom) | São Francisco, Califórnia | Levar para casa exercício sobre problemas do mundo real e discussão com engenheiros sobre exercício
  - [Mente aberta](https://www.openmindonline.it) | Monza, Itália | Entrevistas in loco
  - [OptilYz](https://optilyz.com/careers) - Brasil | Remoto | Leve para casa ou emparelhe a programação em código aberto, depois emparelhe a programação em nosso código de produção real.
  - [Optoro](http://www.optoro.com/open_position_item/?oid=134960) - Brasil | Washington, D.C. | Leve para casa exercícios. Revise seu código no local.
  - [Optum](https://www.optum.in/about/careers.html) | Índia, Hyderabad | Avaliação online, seguida de entrevista técnica e verificação comportamental
  - [Ori](http://ori.co)| Londres, Reino Unido | Entrevista por telefone e um projeto takehome, seguido de uma reunião de duas horas com a equipe
  - [Oriente](https://orient.gg)| Remoto | Três fases: tela do telefone, projeto takehome, videochamada final
  - [OSISMO](https://osism.tech) | Remoto | Três videochamadas: introdução geral, apresentação da equipe, contrato
  - [Ostmoderno](http://www.ostmodern.co.uk) | Londres, Reino Unido | Exercício para casa e discussão no local
  - [Outbrain](https://careers.outbrain.com/?F1C=Netanya&F2C=&FTXT=) - Brasil | Netanya, Israel | Take-home exercício e discussão
  - [Estranho](https://outlandish.com) | Londres, Reino Unido | Leve para casa exercícios, sessões de programação em pares do mundo real, bate-papo amigável com a equipe
  - [Outlook, iOS & Android](https://github.com/outlook/jobs) | São Francisco, CA / Nova Iorque, NY | Projeto Take-home & discussão online / presencial
  - [O Nerdismo](https://www.nerdery.com/careers) | Minneapolis, MN; São Paulo, IL; Fênix, AZ; Cidade de Kansas, KS | Exercício para levar para casa
  - [O Esboço](https://boards.greenhouse.io/theoutline) | Nova Iorque, NY | Exercício para levar para casa

## P - R



  - [PACE Telemática](https://www.pace.car/jobs) | Karlsruhe, Alemanha | Verificação de cultura e mentalidade, encontro no local e grande desafio de código pequeno para ver o estilo e a estratégia de desenvolvimento
  - [Paessler AG](https://www.paessler.com/company/career/jobs) - Brasil | Nuremberga, Alemanha | Emparelhamento com diferentes engenheiros em um problema real
  - [Pagar.me](https://pagar.me) | São Paulo, Brasil | Entrevista via Skype, tarefa de emparelhamento no local e-ou processo / apresentação de solução de problemas do mundo real
  - [Pager](https://pager.com) | Nova Iorque, NY; Remoto | Entrevista curta por telefone, entrevistas conversacionais, exercícios para levar para casa e discussão
  - [PagerDuty](https://pagerduty.com/careers) - Brasil | São Francisco, CA / Toronto, Canadá / Atlanta, GA | Zoom / programação em pares no local e tarefas
  - [Palatinado Tech](https://tech.palatinategroup.com) | Londres, Reino Unido | Hangout/Skype/telefone seguido de tarefa de emparelhamento (normalmente) no local
  - [Papel](https://withpaper.com/careers) | São Francisco, Califórnia | Tela técnica do telefone do Google Atende, tarefa de codificação para levar para casa, no local com arquitetura de webapp, almoço de equipe e conversas com adição de cultura
  - [Parabol](http://parabol.co) - Brasil | Nova Iorque, NY; Los Angeles, Califórnia; Remoto | Verificação de cultura seguida de avaliação de competências de contribuição compensada e [de código aberto](https://github.com/ParabolInc/action/projects)
  - [Soluções Pariveda](http://parivedasolutions.com) | Dallas, TX / Houston, TX / Atlana, GA / Washington, DC / Nova Iorque, NY / Chicago, IL / São Francisco, CA / Seattle, WA / Los Angeles, CA | Avaliação da personalidade (Índice Preditivo) e estudo de caso. Teste de aptidão em programação (independente de linguagem) para contratações universitárias.
  - [PassFort](https://passfort.com/about#jobs) - Brasil | Londres, Reino Unido | Entrevista do Skype e tarefa de emparelhamento no local
  - [Passiv](https://passiv.com) - Brasil | Fredericton, Canadá | Entrevista por zoom, atribuição de codificação para casa, projeto de tamanho de mordida autônomo que oferece algum valor, desenvolvimento de pequenos recursos envolvendo colaboração em equipe.
  - [Pathos Ethos -](https://pathosethos.com/careers/) Brasil | Durham, NC / Raleigh, NC / Chapel Hill, NC / Remoto | 3 entrevistas conversacionais (Gerente, Equipe, Fundador). Sem lição de casa. Procuramos um cadidato para ser "culture add" em vez de "culture fit"
  - [Patas](https://paws.com/careers) | Londres, Reino Unido | Triagem por telefone, projeto take-home, emparelhamento/discussão no local sobre sua solução e conheça a equipe.
  - [Base de pagamento](https://paybase.io) | Londres, Reino Unido | Triagem por telefone, Projeto Take home, Entrevista no local para adequação técnica e cultural, Sessão aberta de perguntas e respostas com a equipe
  - [PayByPhone](https://www.paybyphone.com/careers) | Vancouver, Canadá | Entrevista de programação remota, "conheça a equipe" no local
  - [Empresas Peaksware (TrainingPeaks, TrainHeroic, MakeMusic)](https://peaksware.com) | Ribeiro, CO; Denver, CO - Brasil | Tela do telefone, projeto take home, entrevistas remotas e presenciais para adequação técnica e cultural
  - [PeerStreet](https://info.peerstreet.com/careers) - Brasil | Los Angeles, Califórnia | Telefone, leve para casa o projeto e no local para conhecer a equipe
  - [Pento](https://www.pento.io/) | Remoto | Entrevista pessoal rápida, projeto levar para casa
  - [Permutivo](https://permutive.com/careers/) | Londres, Reino Unido | Telefonema; tarefa de codificação curta e relevante; emparelhamento no local, discussão técnica geral, valores e formas de entrevista de trabalho.
  - [Persado](https://www.persado.com/company/life-at-persado) - Brasil | Nova Iorque, NY | Tela do telefone, levar projeto para casa, reunião remota com membro da equipe para discutir o projeto, reunião remota com o gerente da equipe para discutir a função e analisar conceitos estatísticos relevantes para a função
  - [Persgroep, de](https://www.persgroep.nl/werken-bij-it) | Amesterdão, Países Baixos | Entrevista técnica (formação técnica e experiências) e fit cultural, ambos presenciais
  - [Persona](https://www.withpersona.com/about) | São Francisco, Califórnia | Entrevista técnica (formação técnica e experiências), programação em pares e fit cultural
  - [Pex](https://pex.com/careers/) - Brasil | Los Angeles, Califórnia; Remoto | 3 sessões: breve conversa telefônica (30 min); levar para casa (2 horas); Discussão no local ou em vídeo sem qualquer codificação (2 horas)
  - [PFS](https://empleo.pfsgroup.es) | Madri, na Espanha; Valência, Espanha; Lisboa, Portugal; CDMX, México; Remoto | Adaptamos cada entrevista de acordo com o candidato e o cargo. As entrevistas são discussões abertas (sem questionários) sobre problemas do mundo real. No máximo 2-3 entrevistas, todas elas podem ser feitas remotamente.
  - [Philo](https://philo.com/jobs) - Brasil | São Francisco, CA; Cambridge, MA - Brasil | Tela inicial com aprofundamento em um de seus projetos recentes (30 minutos); Exercício de codificação adaptado às suas habilidades (4 horas); no local com revisão de código take-home, entrevista de arquitetura, entrevista de design e entrevista de "soft skills" (4 horas)
  - [Phoodster](https://www.phoodster.com) - Brasil | Estocolmo, Suécia | Exercício para casa + discussão no local
  - [Torta Seguro](https://www.pieinsurance.com/culture/careers) | Pereira, CO; Oliveira, D.C.; Remoto | Telefone; tela técnica remota emparelhada com outro engenheiro; entrevista remota multi-round para demonstrar habilidades básicas de backend/frontend (sem perguntas bizarras de Leetcode), adequação comportamental/cultural, habilidades de design
  - [Pismo](https://pismo.io/pt/) | Remoto; Bristol, Reino Unido; São Paulo, RJ; Cingapura, Cingapura | Triagem inicial e rápida com recrutadores do departamento de RH, discussão técnica geral remota com líder técnico e membros da equipe, avaliação leve para casa (escolha entre Java e/ou Golang), programação remota em pares.
  - [Pixium Digital](https://pixiumdigital.com) | Cingapura, Cingapura | Entrevista remota ou presencial com poucas perguntas genéricas/técnicas, bem como revisão de portfólio + discussão.
  - [Avião](https://pilot.notion.site/Plane-Careers-Page-0f9a2b64ddd8470f968335b769de0909) | Remoto | Duas chamadas. Introdução um (30m) + verificação de habilidades de comunicação e experiência de trabalho remoto (15m)
  - [Platform.sh](https://platform.sh) | Remoto | Entrevista remota, discussões abrangentes sobre os mais diversos assuntos. Entrevistas remotas com membros da equipe.
  - [Plataforma45](https://platform45.com) | Joanesburgo, África do Sul; Cidade do Cabo, África do Sul | Entrevista in loco, projeto take-home e fit day cultural
  - [Platogo Interactive Entertainment GmbH](https://platogo.com/hiring/) - Brasil | Viena, Áustria | Questionário on-line simples, Primeira entrevista para se conhecer, Desafio de desenvolvedor remoto (levar tarefa para casa), Revisão de código juntos, Conheça a equipe
  - [Playlyfe](https://getcatalyst.in/careers) | Bangalore, Índia | Breve entrevista pessoal, demonstração in loco da programação em ferramentas de desenvolvimento do navegador seguida de discussão sobre o problema
  - [Pleo](https://www.pleo.io/en/careers) | Remoto; Copenhague, Dinamarca; Londres, Reino Unido; Berlim, Alemanha; Estocolmo, Suécia; Madrid, Espanha| Entrevista introdutória (30m-45m), levar para casa, entrevista com discussão sobre a tarefa + questões técnicas com a equipe (90m) e entrevista com gerentes (60m).
  - [Poki](http://jobs.poki.com) - Brasil | Amesterdão, Países Baixos | Pare a programação no local com dois engenheiros, onde nos concentramos no trabalho em equipe, pesquisando documentação relevante e consertando as coisas juntos.
  - [Polar](http://polar.me/company/careers) | Toronto, Canadá | Entrevista por telefone, seguida de 1-2 entrevistas presenciais com programação em pares com base em sua plataforma
  - [Enquete em todos os lugares](https://www.polleverywhere.com/jobs) | Remoto | Chamada de introdução, 1 hora de avaliação técnica para casa, sessão de emparelhamento com Designer e Engenheiro para melhorar a submissão de desafios técnicos, Reunião com CTO e gerente de contratação.
  - [Popstand](http://www.popstand.com) | Los Angeles, Califórnia | Crie MVPs para startups
  - [Pagamento Popular](http://www.popularpays.com) | Chicago, IL - Brasil | Bate-papo/café por telefone para determinar o que será trabalhado durante um dia de programação em pares sobre um problema real que o candidato acha que melhor demonstra suas habilidades.
  - [Posit](https://posit.co/) | Remoto | Chamadas de vídeo com recrutador, em seguida, gerenciamento de engenharia, levar projeto para casa, chamada de vídeo para revisão de código com líder de engenharia
  - [Pragmateam](https://pragma.team/talent) - Brasil | Sydney, Austrália | Consultoria De Engenharia E Entrega - Takehome exercício & discussão
  - [PremiumBeat](https://www.premiumbeat.com/careers) | Montreal, Canadá | Discussão e perguntas gerais de alto nível
  - [Primária](https://www.primary.com/jobs) | Nova Iorque, NY / Remoto | Converse por telefone, leve exercícios para casa, programe em pares e discuta no local.
  - [Progressiva](https://www.progressive.com/careers/) | Mayfield Village, OH / Remoto | Tela do telefone do recrutador, seguida de 2 entrevistas STAR de uma hora com [o gerente](https://www.progressive.com/careers/how-we-hire/application-next-steps/interviewing/) e 1 [entrevista técnica STAR](https://www.progressive.com/careers/life/how-to-prepare-for-a-technical-screening/) de uma hora.
  - [Manter](https://www.prokeep.com/careers) | Remoto | Projeto take-home, bate-papo informal com gerentes.
  - [O PromptWorks](https://www.promptworks.com/jobs) | Filadélfia, PA | Projeto take-home, programação em dupla, discussão no local
  - [PropriedadeCapitão](https://www.propertycaptain.ch) | Zurique, Suíça | Projeto Take-home, discussão no local
  - [Procuração](https://www.proxy.com) | São Francisco, Califórnia | Bate-papo por telefone. Discussão aprofundada sobre experiências no local. Ocasionalmente um projeto de levar para casa.
  - [Empurrador](https://pusher.com/jobs) | Londres, Reino Unido | Resolva um problema do mundo real através de uma sessão de projeto com nossos engenheiros
  - [Pigmalios](http://pygmalios.com/en) | Bratislava, Eslováquia | Projeto Take-home relacionado a negócios e discussão com nossos engenheiros.
  - [Qonto](https://qonto.com/en/careers) - Brasil | Paris, França / Berlim, Alemanha / Milão, Itália / Barcelona, Espanha / Belgrado, Sérvia / Remoto | Projeto take-home, revisão de código e discussões com nossos engenheiros.
  - [Comunicações Silenciosas com Luz](https://quietlightcom.com/positions-web.php) | Rockford, IL, Estados Unidos | Discussão, amostras de trabalho e/ou pequeno projeto freelance
  - [Quintype](http://www.workatquintype.com) | Bangalore, Índia / San Mateo, Estados Unidos | Leve para casa projeto, programação em par, discussão no local
  - [Quizizz](https://quizizz.com) | Bangalore, Índia | Bate-papo por telefone, atribuição do mundo real, discussão com desenvolvedores, programação em par, discussão no local
  - [Quizlet](https://quizlet.com/careers) | Remoto; São Francisco, CA; Nova Iorque, NY; Londres, Reino Unido | Tela preliminar seguida de exercícios aplicados específicos da função, onde os candidatos criam novos projetos/aplicativos ou fazem melhorias no código pré-existente.
  - [Ragnarson](https://ragnarson.com) - Brasil | Lodz, Polônia; Remoto | Take-home exercício & sessão de programação em pares
  - [Railscarma](https://www.railscarma.com) - Brasil | Bangalore, Índia | Projeto take-home, revisão de código e discussão no local
  - [Railslove](https://www.railslove.com) - Brasil | Colônia, Alemanha | Tome um café em nosso escritório, converse casualmente conosco, combine programação em um projeto real
  - [Aumentando a TI](https://www.raisingit.com) | Londres, Reino Unido | Café com um membro da equipe, programação em pares no local e discussão
  - [Rampa](https://ramp.com) | Nova Iorque, NY | Entrevista por telefone sobre um problema básico aplicado, seguida de 2-3 entrevistas de programação no local que testam habilidades práticas de software do dia-a-dia.
  - [RapidAPI](https://rapidapi.com/company/careers/) | São Francisco, CA; Berlim, Alemanha; Tallinn, Estónia | Leve para casa a tarefa e a discussão antes/depois
  - [Rapptr Labs](http://careers.rapptrlabs.com) - Brasil | Cidade de Jersey, NJ | Exercício para levar para casa seguido de uma entrevista em vídeo com 2-3 engenheiros sobre conhecimentos específicos do domínio e perguntas abertas.
  - [Rapyuta Robótica](http://www.rapyuta-robotics.com/pages/jobs.html) | Bangalore, Índia / Tóquio, Japão / Zurique, Suíça | Take-home assignment relacionado aos nossos projetos em andamento, série de entrevistas técnicas / baseadas em experiência, apresentação de candidatos
  - [Alimentação Rayfeed](https://rayfeed.com) | Vancouver, Varsóvia | Entrevista por videochamada seguida de um exercício para levar para casa
  - [Razorpay](https://razorpay.com/jobs) - Brasil | Bangalore, Índia | Tela do telefone, programação em pares no local e, ocasionalmente, um projeto de levar para casa.
  - [Reaktor](https://reaktor.com/careers) - Brasil | Nova Iorque, NY; Amsterdã, Holanda; Helsínquia, Finlândia; Tóquio, Japão | Discussão, amostras de trabalho de projetos anteriores (trabalho ou hobby), exercícios para levar para casa, se necessário, para mais informações
  - [Realync](https://realync.com/careers) - Brasil | Chicago, IL / Carmel, IN / Remoto | Entrevista rápida por telefone, depois um projeto de levar para casa e, finalmente, entrevista presencial (discussões abertas em vez de questionários - qualquer coisa técnica são problemas do mundo real).
  - [Rebase Consultoria](https://rebase.fi) | Helsínquia, Finlândia / Remoto | Discussão/introduções gerais da primeira rodada, entrevista técnica da segunda rodada construída em torno de um exercício de levar para casa, matriz de habilidades/interesses 2x2 e tópicos técnicos gerais com base no perfil do candidato.
  - [Texugo Vermelho](https://red-badger.com/about-us/join-us) | Londres, Reino Unido | Telefone & Entrevista via Skype, faça exercícios para casa, Entrevista no local
  - [Balão Vermelho de Segurança](https://redballoonsecurity.com) | Nova Iorque, Estados Unidos | Um desafio de hacking bastante educacional de uma semana com uma recompensa monetária uppon encontrar solução. No local com membros da equipe, problemas reais relacionados ao trabalho, algumas perguntas abertas.
  - [Tapete Vermelho](https://www.redcarpetup.com/jobs) | Nova Deli, Índia | Entrevista, amostra de trabalho/projeto take-home e discussão/revisão de código
  - [Redgate](https://www.red-gate.com/our-company/careers/current-opportunities/) - Brasil | Cambridge, Reino Unido | Duas perguntas simples durante a fase de triagem (até 30 min) seguidas de uma segunda fase com até dois exercícios de codificação (não-CS).
  - [Redutor](https://reducer.co.uk) | Londres, Reino Unido | Apresentações por telefone, programação em pares no local, depois encontro com a equipe.
  - [Reflektive](https://www.reflektive.com/careers/) | São Francisco, CA; Bangalore, Índia | Um pequeno projeto/tarefa para casa, seguido por algumas discussões técnicas e não técnicas on-line e off-line.
  - [Refty](https://refty.co) | Paris, França | Videochamada introdutória, processo de avaliação de soft skills alimentado por nosso próprio produto, discussão no local, almoço com todos.
  - [Relabe](https://relabe.com) - Brasil | São João, PR | Primeiro, fazemos uma triagem para adequação cultural e, em seguida, verificamos a proficiência técnica. 2-3 Máximo de entrevistas em SJ
  - [Remoto](https://remote.com) | Remoto | Ligue com um recrutador (se necessário), ligue com gerente, faça exercício de código, ligue com a equipe.
  - [Renderização](https://render.com/careers) | São Francisco, CA; Remoto | Tela do telefone seguida por um projeto no local baseado em nossos desafios do dia-a-dia, do mundo real.
  - [Alugue](https://www.rentify.com/jobs) | Londres, Reino Unido | Telefonema, leve para casa projeto do mundo real, programação de pares no local, discussão de produtos
  - [RentoMojo](https://www.rentomojo.com/about/careers) - Brasil | Bangalore, Índia | Projeto Short takehome + entrevista por telefone
  - [Repl.it](https://repl.it/site/jobs) | São Francisco, Califórnia / Remoto | Projeto e discussão em casa, depois um projeto e discussão no local
  - [Resin.io](https://resin.io) | Remoto | Leve para casa um projeto do mundo real e algumas discussões técnicas e não técnicas
  - [Recursos](https://www.resourcify.com) | Hamburgo, Alemanha; Remoto | Conheça telefonema com Gerente de Engenharia e VP de Pessoas, combine programação de um problema do dia-a-dia com um Engenheiro Líder, reunião com membros da equipe.
  - [ReSpark](https://www.respark.co.uk) - Brasil | Londres, Reino Unido | Conversa telefônica seguida de entrevista no local com tarefa relevante para a função diária.
  - [RestaurantOps](https://www.restaurantops.co) | Scottsdale, AZ - Brasil | Take Home Project & sessão de programação em pares
  - [Pulso de varejo](https://retailpulse.ai) | Bangalore, Índia | Bate-papo por telefone, exercícios para casa, feedback e entrevista
  - [Rever](https://reverscore.com) | Guadalajara, México | Projeto Take-home, discussão no local ou via Hangouts.
  - [ReviewTrackers](https://www.reviewtrackers.com/careers/) | Remoto; Chicago, IL - Brasil | Conversa telefônica, levar projeto para casa, entrevista virtual com revisão de projeto e codificação ao vivo, discussão com engenheiros e produto, entrevista com VP de Engenharia
  - [Revlv](https://revlv.net) - Brasil | Manila, Filipinas | Discussão sobre habilidades de desenvolvedor, projetos anteriores e experiências.
  - [Software Rex](https://www.rexsoftware.com/careers) | Brisbane, Austrália | Leve para casa projeto, feedback + entrevista
  - [Rizk.com](https://rizk.com) | Ta' Xbiex, Malta | Take-home assignment, discussão com desenvolvedores
  - [Rockerbox](https://www.rockerbox.com/careers) | Remoto | Tela do telefone com programação em par. 2 horas de preparação pré-entrevista. Entrevista final de 4 horas com perguntas situacionais, outra programação em dupla e apresentação e discussão dos resultados da preparação pré-entrevista.
  - [Viagem de Foguete](https://about.rocketmiles.com) | Remoto; São Paulo, IL; Nova Iorque, NY | Programação em dupla, projeto leve para casa (2-4 horas), entrevista final de 3-4 horas com mistura de sessões técnicas, de produto e culturais/comportamentais de alto nível.
  - [Rockode](http://www.rockode.com) - Brasil | Bangalore, Índia | Atribuição no mundo real, sessão de hack em grupo, discussões
  - [Rosa Digital](http://rosedigital.co) | Nova Iorque, NY | Conversa telefônica seguida de componentes de codificação de pares que espelham o trabalho do dia a dia, discussão presencial sobre código, projeto levar para casa se necessário para obter mais informações
  - [Ruangguru](https://career.ruangguru.com) - Brasil | Jacarta, Indonésia / Yogyakarta, Indonésia / Malang, Indonésia / Bandung, Indonésia | Triagem telefônica com recrutador técnico --> codificação ao vivo com um engenheiro --> entrevista de painel com engenheiros relacionados (Engenheiros de Teste, Engenheiros Frontend, Engenheiros de Backend, etc) --> entrevista final com VP de Engenharia
  - [RubyGarage](https://rubygarage.org) - Brasil | Dnipro, UA - Brasil | Projeto take-home, revisão de código e discussão no local
  - [Runtastic](https://www.runtastic.com) - Brasil | Linz, Áustria; Viena, Áustria | Videochamada com equipe de recrutamento, projeto levar para casa, chamada de vídeo para revisão de código, discussão, perguntas
  - [RVU](https://www.rvu.co.uk/careers) - Brasil | Londres, Reino Unido | Também conhecido como Uswitch / Money.co.uk / Bankrate, pequeno projeto de take-home relacionado à nossa área de negócios, seguido de emparelhamento de livro aberto com desenvolvedores para estendê-lo seguido de sessão de perguntas e respostas para discutir sua experiência.

## S - U



  - [SafeButler](https://www.safebutler.com) - Brasil | São Francisco, Califórnia | Projeto leve para casa e, em seguida, uma entrevista presencial ou remota com uma revisão, programação em pares e discussões de adequação à cultura
  - [Software Sahaj](https://www.sahaj.ai) | Bangalore, Índia; Chennai, Índia; Pune, Índia; Melbourne, Austrália; Londres, Reino Unido; São José, Califórnia | Leve para casa o código + Emparelhamento + Discussão
  - [Velejando Byte](https://sailingbyte.com) | Rumia, Polônia | Entrevista técnica, Take-home Task
  - [Sakari](https://sakari.io) - Brasil | São Francisco, Califórnia | Tela do telefone, atribuição de programação relacionada ao negócio Sakari (comunicações) com elemento de programação em par, equipe e fit de cultura
  - [Ciclo de Venda](https://www.salecycle.com/careers) | Durham, Reino Unido; Brighton, Reino Unido | Tela do telefone, discussão cara a cara com desenvolvedores, sessão de emparelhamento opcional e discussão
  - [Vendascinco](https://www.salesfive.com/jobs) | Munique, Alemanha; Berlim, Alemanha | Tela do telefone, Entrevista por telefone com o desenvolvedor para discutir código e desafios, Leve para casa o desafio se necessário. Visita in loco
  - [Salesloft](https://salesloft.com) | Atlanta, Geórgia | Entrevista por telefone, projeto take-home, entrevista cultural-fit, entrevista técnica onde candidato modifica projeto take-home
  - [Samsara](https://www.samsara.com/jobs) - Brasil | São Francisco, CA; Brasília, Geórgia; Londres, Reino Unido | Entrevista por telefone, entrevista no local (desafios técnicos baseados em problemas reais que enfrentamos na Samsara)
  - [SC5 Online](https://sc5.io/careers) | Helsínquia, Finlândia; Jyväskylä, Finlândia | Tarefa para levar para casa (intencionalmente curta, leva no máximo uma hora para ser concluída), tarefas de discussão e revisão
  - [Escafo](https://scapic.com/careers/) | Bangalore, Índia | Projeto Short takehome + entrevista por telefone
  - [Schibsted Tech Polska](https://www.schibsted.pl) - Brasil | Gdańsk, Polónia | Tela do telefone, exercício para levar para casa, revisão de código e discussão técnica
  - [Gangorra](https://boards.greenhouse.io/seesaw) | Remoto | Desafios técnicos baseados em problemas do mundo real
  - [Segmento](https://segment.com) | São Francisco, CA; Vancouver, Canadá | Entrevista por telefone, tarefa para levar para casa (pequeno projeto divertido), entrevista no local (técnica + núcleo / cultura) -> destinado a prepará-lo para o sucesso
  - [SEITENBAU](https://www.seitenbau.com/karriere/aktuelle-jobangebote) - BRASIL | Konstanz, Alemanha | Recrutamento por pares; entrevistas conversacionais (videochamada ou presencial) com outros desenvolvedores e RH com foco em motivação, atitude, habilidades; possivelmente 2ª reunião de entrevista presencial com outros membros da equipe
  - [Sendyne](http://www.sendyne.com) - Brasil | Nova Iorque, Estados Unidos | Tela do telefone, no local com os membros da equipe. Revisão de experiências passadas + perguntas sobre problemas reais.
  - [Torre de Sensores](https://sensortower.com/jobs) | São Francisco, Califórnia | Telefonema, entrevista no local, incluindo discussão sobre projetos/habilidades e um breve desafio de programação do mundo real
  - [Sensu](https://sensu.io) | Remoto | Chamada de vídeo, escolha de sessão de emparelhamento ou tarefa de programação para casa
  - [Séntisis](http://sentisis.com/trabaja-con-nosotros) | Madri, na Espanha; Cidade do México, México; Bogotá, Colômbia; Santiago do Chile, no Chile; Remoto | Chamada telefônica, entrevista presencial/remota, incluindo discussão sobre projetos/habilidades e um breve exercício de programação em pares do mundo real
  - [SerpApi](https://serpapi.com) - Brasil | Austin, TX / Remoto | Entrevista de valor e cultura do Skype, revisão de contribuições no GitHub ou em outras plataformas e projeto de levar para casa se as contribuições on-line não forem suficientes.
  - [Sertis](https://sertiscorp.com) - Brasil | Banguecoque, Tailândia | Entrevista técnica e cultura de fit , projeto take-home, discussão de acompanhamento
  - [Setapp Sp. z o.o.](https://setapp.pl/career) | Poznan, Polónia | Discussão on-line/cara a cara com desenvolvedores sobre dilemas de programação do dia a dia e revisão de seu próprio código
  - [Sharoo](https://www.sharoo.com/jobs/) - Brasil | Zurique, Suíça; Remoto | Entrevista de soft skills, projeto take home, entrevista técnica baseada no projeto take home.
  - [Navio&co](https://www.shipandco.com/en/) | Remote / Quioto, Japão | Entrevista casual não técnica com o CEO. Uma hora de discussão técnica com desenvolvedor líder sobre desenvolvimento de software, habilidades e experiência passada. Três meses de período experimental pago.
  - [Shogun](https://getshogun.com) - Brasil | Remoto | Discussão sobre desenvolvimento de software e experiência passada, exemplos de código, período de teste pago.
  - [Atalho](https://shortcut.com/careers) | Nova Iorque, NY & Remote | Entrevista por telefone, seguida de discussões no local e programação em pares
  - [Showmax](https://blog.showmax.com/engineering-careers) - Brasil | Beroun, na República Tcheca; Praga, República Tcheca; Remoto | Leve para casa o projeto, depois uma rodada de programação em pares e discussão no local / Hangouts.
  - [ShuttleCloud](https://shuttlecloud.com/jobs) - Brasil | Chicago, IL / Madrid, Espanha | Projeto Take-home, em seguida, o passo a passo do código no local e uma discussão de problemas do mundo real.
  - [Sinal AI](https://www.signal-ai.com/about-us/careers) | Londres, Reino Unido | Tela do celular; levar para casa o exercício de código; extensão de código no local com programação em pares e discussão
  - [SigNoz](https://signoz.io) - Brasil | Bangalore, Índia; Remoto | Rodada de introdução para explorar interesses, 1-2 Entrevistas técnicas que se assemelham a um problema que a SigNoz resolve, depois rodada de produtos para discutir sobre a indústria e os problemas que a SigNoz está resolvendo.
  - [Simpli.fi](https://www.simpli.fi/about-us/careers) | Fort Worth, TX, Estados Unidos | Desafio e revisão do código Takehome
  - [SimpliField](http://www.welcometothejungle.co/companies/simplifield/jobs) | Lille, França | Entrevista com o CTO e a equipe de desenvolvedores
  - [Simplesmente Negócios](https://www.simplybusiness.co.uk/about-us/careers/tech) | Londres, Reino Unido / Remoto | Três etapas, um dia de entrevista com feedback rápido. Uma das etapas é uma sessão de programação em pares de 1,5h, onde o entrevistado recebe uma tarefa e o desenvolvedor entrevistador desempenha o papel de Product Owner.
  - [Seis vezes](https://sixfold.com/careers) | Tallinn, Estônia; Tartu, Estônia; Viena, Áustria | 3-4 etapas: 1ª entrevista com RH e um líder de engenharia, 2ª uma tarefa-teste para resolver em casa, 3ª discussão técnica e feedback sobre a tarefa-teste, 4ª reunião opcional com mais líderes de engenharia para encontrar a equipe mais adequada.
  - [Sixt](https://www.sixt.jobs/en) - Brasil | Munique, Alemanha | 4 etapas: 1ª RH, 2ª leva para casa, 3ª discussão de acompanhamento, 4ª entrevista in loco com equipe mais RH
  - [Skylight Digital](https://skylight.digital/join/) | Remoto | Chamada de triagem para determinar o interesse geral, exercício de programação de pares de 1,5 hora com base em cenário realista, entrevista EQ.
  - [Skyrise Pro](https://www.skyrisepro.com) - Brasil | Chicago, IL - Brasil | Projeto de codificação para levar para casa, entrevista no local, incluindo aprimoramentos de codificação para o projeto de levar para casa, atividade de grupo externa
  - [Folga](https://slack.com/jobs) | São Francisco, Califórnia | Chamada com recrutador, projeto de 1 semana para levar para casa, chamada com gerente de contratação, entrevista no local cobrindo design de sistema de alto nível, melhores práticas de desenvolvimento de software e adequação à cultura
  - [Pequenas Melhorias](https://www.small-improvements.com/careers) | Berlim, Alemanha
  - [Smartia](https://smartia.tech) - Brasil | Bristol, Reino Unido; Remoto | Leve para casa projeto do mundo real para concluir, ligue com chefe de engenharia, cultura fit com CEO e COO
  - [Smartly.io](https://www.smartly.io/developer) | Helsínquia, Finlândia | Discussão com recrutador e desenvolvedores e exercícios de codificação em pares
  - [Smile.io](https://smile.io/careers) | Kitchener, Canadá / Remoto | Projeto do mundo real, entrevistas com RH e equipe de engenharia
  - [Snyk](https://snyk.io/jobs) - Brasil | Londres, Reino Unido; Tel Aviv, Israel | Leve para casa a tarefa e, em seguida, uma codificação de par nela
  - [Mesas Sociais](http://www.socialtables.com) | Washington, D.C. | Converse sobre habilidades e experiências passadas + traga um exemplo de código de trabalho anterior ou projeto paralelo para discutir
  - [Roupas moles](https://softwear.nl/vacatures) | Amesterdão, Países Baixos | Escrevendo software para a indústria da moda – remotamente – em uma equipe internacional.
  - [Sogilis](http://sogilis.com) - Brasil | Grenoble, França | Discussão sobre interesses, práticas e motivação. Apresentação/revisão de código/programação em par em um projeto pessoal ou profissional.
  - [Fontegráfica](https://about.sourcegraph.com/jobs) | São Francisco, CA & Remoto | Adaptado ao candidato, muitas vezes consiste em levar para casa o trabalho, discussão de desafios eng do mundo real e familiaridade com o produto.
  - [Emenda](https://jobs.splice.com) | Nova Iorque, NY; Remoto | Chamada com recrutador, projeto take-home de 4 horas, entrevista por vídeo com dois engs no exercício take-home, chamada de vídeo com gerente de contratação, chamada de vídeo com VPE e principal eng para falar sobre arquitetura.
  - [Splyt](https://careers.splyt.com) - Brasil | Londres, Reino Unido; Cingapura, Cingapura; Kuala Lumpur, Malásia; Tóquio, Japão | Triagem inicial com recrutadores do departamento de RH, take home assessment (React + Node.js), seguida de entrevistas remotas/presenciais com gerente de contratação e CTO sobre a avaliação, design/arquitetura do sistema e fit cultural.
  - [Spreedly](https://www.spreedly.com/jobs) | Durham, Carolina do Norte | Projeto Take-home [relacionado a negócios](https://engineering.spreedly.com/blog/programming-puzzles-are-not-the-answer-how-spreedly-does-work-samples.html)
  - [Springer Nature (Ásia)](https://www.natureasia.com) | Tóquio, Japão | Discussão & Par sessão de programação
  - [Springer Natureza Digital](https://sndigital.springernature.com) | Berlim, Alemanha; Londres, Reino Unido | Bate-papo por telefone; projeto take-home; em seguida, uma sessão de emparelhamento com base no projeto, um bate-papo técnico e um bate-papo com membros não técnicos da equipe
  - [SpronQ](https://www.spronq.nl) - Brasil | Amesterdão, Países Baixos | Desafio de codificação Takehome
  - [Squadcast](https://www.squadcast.com/careers) | Bangalore, Índia | Triagem por telefone, entrevista técnica, entrevista com fundadores.
  - [Praça](https://squareup.com/careers) | São Francisco, Califórnia | Emparelhar a programação em um ambiente de trabalho
  - [Sentido Quadrado](https://square-sense.com) | Paris, França | Tela curta do telefone para confirmar o interesse, levar para casa projeto (semelhante a alguns dos nossos softwares existentes), uma entrevista de programação em pares onde faremos algumas alterações no mesmo projeto
  - [Srijan Tecnologias](http://srijan.net) | Delhi, Índia | Perguntas gerais de alto nível / discussão seguida de programação em pares OU desafio de codificação take-home
  - [Stacc](https://stacc.com/) - Brasil | Noruega, Bergen | Tarefa aberta de levar para casa (UX e/ou codificação no idioma de sua preferência) seguida de uma discussão de alto nível e reflexão sobre o processo com engenheiros seniores.
  - [União Stardog](http://stardog.com) | Washington, DC; Remoto | Discussão técnica e conversas de interesse geral
  - [StartDee](http://startdee.com) - Brasil | Banguecoque, Tailândia | Triagem telefônica com recrutador técnico --> codificação ao vivo com um engenheiro --> entrevista de painel com engenheiros relacionados (Engenheiros de Teste, Engenheiros Frontend, Engenheiros de Backend, etc) --> entrevista final com VP de Engenharia
  - [StashAway](https://www.stashaway.sg/careers) - Brasil | Cingapura, Malásia & Remote | Leve para casa a tarefa técnica (dividida em frontend ou back-end focada), a rodada de design de caso de arquitetura de banco de dados, a rodada de equipe ponto a ponto (P2P) e a entrevista de gerenciamento
  - [Statflo - Brasil](http://statflo.com) | Toronto, Canadá | Triagem por telefone, projeto take home, entrevista no local discutindo o projeto take home, brainstorm arquitetônico de alto nível e perguntas sobre carreira e trabalho em equipe.
  - [Loja2Be](https://www.store2be.com/en/pages/jobs) | Berlim, Alemanha | Entrevista via Skype/no local, projeto take-home
  - [Tempestade](https://www.stormx.io/about#jobs) | Ribeiro, WA; Remoto | Tela de telefone/skype --> Take-home coding assignment --> loop de entrevista no local/skype para discutir a atribuição; meet-and-greet com outras equipes --> +1/-1 com base no consenso da equipe
  - [Storytel](https://jobs.storytel.com/departments/tech) | Estocolmo, Suécia; Lund, Suécia; Karlstad, Suécia; Umeå, Suécia; Copenhaga, Dinamarca | Nosso processo tem poucas etapas: uma entrevista social com o RH e 1-2 futuros companheiros de equipe; um pequeno projeto de levar para casa seguido de uma discussão técnica com 2-3 futuros colegas. Todas as etapas podem ser presenciais em um de nossos escritórios ou via Google Meet
  - [Stride Consultoria](https://www.stridenyc.com) | Nova Iorque, NY / Chicago, IL | Tela do telefone, visão geral ágil e técnica, uma sessão de emparelhamento e entrevista de arquitetura sobre a experiência anterior.
  - [Structura Biotecnologia](https://structura.bio) | Toronto, Canadá | Triagem por telefone, desafio de codificação para levar para casa, revisão e discussão no local sobre a experiência passada e brainstorm arquitetônico de alto nível
  - [STRV](https://strv.com/careers) - Brasil | Praga, República Tcheca; Brno, República Tcheca; Remoto | Uma entrevista social com um recrutador + desafio de codificação para levar para casa, seguida de uma sessão de entrevista técnica discutindo sua abordagem na resolução da tarefa de levar para casa + uma entrevista de adequação cultural com o chefe de engenharia.
  - [STYLABS](http://www.stylabs.in) | Mumbai, Índia | Tela do telefone, projeto Take-home e discussão no local
  - [Subvertical (VerticalChange)](https://verticalchange.com/job_posts) | Remoto | Triagem por telefone, programação em pares ao vivo e revisão de código de projeto pessoal
  - [Sulvo](https://sulvo.com/careers) - Brasil | Nova Iorque, NY / Remoto | Entrevista por videochamada para adequação cultural primeiro, se você passar, prosseguimos com entrevista técnica que não inclui jogos de codificação ou desafios
  - [Cúpula](https://careers.summitto.com) | Amesterdão, Países Baixos | Desafio de codificação para casa e entrevista no local
  - [SumUp](https://www.sumup.com/careers/) | Londres, Reino Unido | Processo de entrevista em cinco etapas. A primeira etapa é com o RH. A segunda etapa é com o gerente de Engenharia - discussão sobre conhecimentos gerais de engenharia e projetos passados. A terceira etapa é a cessão de levar para casa. A quarta etapa é uma discussão da solução de atribuição para casa com dois engenheiros. A quinta etapa é uma entrevista comportamental estruturada em torno dos valores da empresa.
  - [SuperIncrível](https://www.superawesome.com) | Londres, Reino Unido | Tela curta do telefone do recrutador, exercício para levar para casa, design do sistema de acompanhamento e entrevista cultural focada em sua experiência passada.
  - [Superjogador](https://superplayer.fm) | Porto Alegre, Brasil | Entrevista via Skype/On-site, projeto take-home e entrevista com CTO e CEO
  - [Cirurgiões](https://surglogs.com/careers/slovakia/) | Remoto | (Fuso horário Europa) Tela do telefone, tarefa para levar para casa com uma chamada de acompanhamento ou codificação ao vivo focada na criação de cenários simples do mundo real (com base em sua preferência), chamada adequada à cultura com equipe e CTO.
  - [SurveySparrow - Brasil](https://surveysparrow.com/careers) | Kochi, Índia | Entrevista via Skype, revisão de projeto e código para casa, entrevista com CTO e CEO
  - [Svix](https://www.svix.com) - Brasil | Remoto | Leve para casa o projeto, uma entrevista para discutir o projeto e uma entrevista de fit cultural.
  - [SVTi (Televisão Sveriges)](http://svti.svt.se) | Estocolmo, Suécia | Entrevista no local, projeto take-home, entrevista de acompanhamento onde você mostra como escolheu resolver a tarefa.
  - [SweetIQ](https://sweetiq.com/about/careers) - Brasil | Montreal, Canadá | Discussão e perguntas gerais de alto nível
  - [Rapidamente](https://www.swiftly.com/about/careers) | Ribeiro, WA; São Francisco, Califórnia | Projeto de codificação take-home, discussões de princípios de design, solução colaborativa de problemas
  - [Suíça](https://www.swisscom.ch/en/about/career.html) | Roterdão, Países Baixos | Uma mistura de entrevista comportamental, técnica e cultural, projeto take-home, revisão de projeto com engenheiros de diferentes equipes e entrevista cultural com membros da equipe.
  - [Symphony Comércio](https://www.symphonycommerce.com/careers) | São Francisco, Califórnia / Remoto | Projeto Take-home (telefone), discussão de design, revisão e crítica _de nosso_ código, depurando perguntas
  - [Simplicidade](https://www.symplicity.com/about/join-us) | Arlington, VA - Brasil | Projeto take-home e revisão de código pessoalmente
  - [SysGarage](http://sysgarage.com) - Brasil | Buenos Aires, Argentina | Projeto Take-home e programação de pares do mundo real
  - [Verificação de Tabela](https://www.tablecheck.com/en/company/jobs/) | Tóquio, Japão | Mostre-nos o seu código! Breve chamada em seguida, levar para casa projeto ou emparelhamento para aqueles sem código.
  - [Marcas sob medida](https://tailorbrands.com/jobs) | Tel Aviv-Yafo, Israel | Discuta conhecimentos e interesses, explore experiências de trabalho anteriores, durante a entrevista técnica discutimos problemas da vida real.
  ...
  - [Textio](https://textio.com/careers/?utm_source=github&utm_medium=forum&utm_campaign=textio-careers-engineering&utm_content=poteto-hiring-without-whiteboards) - Brasil | Seattle, WA - Brasil | Tela inicial para discutir experiência e interesse em uma função na Textio; em seguida, uma tarefa de programação para levar para casa é discutida durante uma tela técnica de 1 hora (no local ou remota); finalmente, um projeto maior de levar para casa, simulando um trabalho real, é discutido durante uma apresentação no local mais 1-1s; [Como contratamos](https://textio.ai/how-we-hire-a74cdbadd1e8)
  - [O Livro de Todos](https://thebookofeveryone.workable.com) | Barcelona, Espanha | Entrevista rápida, conheça a equipe, emparelhando com desenvolvedores em seu próprio projeto
  - [O Grupo LEGO](https://lego.com) | Billund & Copenhaga, Dinamarca; Enfield, EUA; Londres, Reino Unido; | Primeira reunião para discutir interesses, equipe e questões gerais. Em seguida, o estudo de caso/projeto take-home, seguido de outra reunião discutirá a solução de alto nível com foco no processo e nos pensamentos por trás da solução.
  - [A Zebra](https://www.thezebra.com/about/careers/) | Austin, TX - Brasil | Desafio de codificação leve para casa com revisão presencial e programação em pares.
  - [Thinkmill](https://www.thinkmill.com.au) - Brasil | Sydney, Austrália | Entrevista inicial com a Thinkmillers da equipe relevante, leve para casa a tarefa seguida de revisão técnica em uma entrevista de acompanhamento.
  - [Fatias finas](http://www.thinslices.com) | Iasi, Romênia | Leve para casa o exercício e a programação em pares presenciais em um Kata simples.
  - [ThoughtBot](https://thoughtbot.com/jobs) - Brasil | São Francisco, CA; Londres, Reino Unido | [Nosso processo de entrevista](https://thoughtbot.com/playbook/our-company/hiring#interviewing)
  - [ThoughtWorks](https://www.thoughtworks.com/careers) - Brasil | São Francisco, Califórnia | Entrevistas com ThoughtWorkers de diversas origens e papéis; levar para casa a tarefa seguida de uma sessão de emparelhamento presencial.
  - [ThoughtWorks Cingapura](https://www.thoughtworks.com/careers/singapore) | Cingapura, Cingapura | Entrevistas com ThoughtWorkers de diversas origens e papéis; Exercício de codificação simples e ao vivo emparelhado na linguagem de escolha focado em código limpo, não em velocidade. Seguido de entrevista de refatoração emparelhada e discussão técnica sobre modelagem e design de sistemas, profundidade tecnológica e amplitude e habilidades de liderança de equipe (se aplicável).
  - [Rosca](https://www.thread.com/jobs) | Londres, Reino Unido | Faça teste em casa, design de arquitetura do mundo real, programação de pares do mundo real.
  - [Laboratórios ThreatSpike](https://www.threatspike.com) | Londres, Reino Unido | Leve para casa os desafios relacionados à computação e segurança a serem concluídos ao longo de uma semana.
  - [Tilde](http://www.tilde.io) | Portland, OU | Emparelhe sessões de programação com cada membro da equipe, trabalhando em problemas semelhantes ao trabalho diário.
  - [Tombuctu](https://www.timbuktutravel.com) | Cidade do Cabo, África do Sul | Entrevista no local e exercício de programação em pares
  - [Tipalti](https://tipalti.com) - Brasil | Glil-Yam, Israel | Desafios de design e codificação do mundo real
  - [Titânio](https://titanium.codes) | Moldávia, Chisinau | Revisão de alto nível da atividade pública no GitHub/BitBucket/Gitlab (se aplicável) e triagem via telefone, Entrevista de adequação da equipe técnica no local, reunião formal "Conheça a equipe"
  - [Toggl](https://toggl.com/jobs) | Remote / Tallinn, Estónia | Teste on-line sobre habilidades básicas de programação, seguido de entrevista (normalmente inclui perguntas de conhecimento e teste de habilidades técnicas). Dependendo da equipe, pode haver uma tarefa de codificação para levar para casa ou ao vivo. **Semana de teste paga** para trabalhar com a equipe em bugs/recursos reais.
  - [Tooploox](https://www.tooploox.com/careers) - Brasil | Varsóvia, Polônia; Wroclaw, Polônia; Gdansk, Polônia; Remoto | Entrevista de adequação da equipe e, em seguida, projeto de levar para casa. Próxima entrevista presencial ou remota que consiste em discussão e codificação ao vivo com base no código entregue. Foco em questões de alto nível, arquitetura e decisões de design.
  - [Toowoxx](https://toowoxx.de/index.php/karriere/) - Brasil | Deisenhausen, Alemanha & Ulm, Alemanha | Breve entrevista com perguntas gerais, desafio de programação no local, revisão de código do resultado
  - [Cartola](https://tophat.com/company/work-with-us/) | Remoto / Toronto, Canadá | Desafio de codificação curto inspirado no espaço de problemas do dia-a-dia, seguido por um exercício mais longo de design e implementação de emparelhamento de front-end ou back-end
  ...
  - [Massagem Urbana](https://www.urbanmassage.com/jobs) | Londres, Reino Unido | Projeto feito em casa, presencial. Conhecer a equipe é parte integrante.
  - [UserTesting](https://www.usertesting.com/about-us/jobs) | Brasília, Geórgia; São Francisco, CA; Vista para a montanha, Califórnia | Entrevista inicial, programação em pares e oferta

## V - X



  - [V7](https://www.v7labs.com/careers) | Londres, Reino Unido; Remoto | Triagem inicial pela equipe de Talentos, primeira tela técnica (design de aplicativo / sistema), atribuição de take-home e revisão de acompanhamento com conversa extra de design de aplicativo / sistema
  - [Valassis Digital](http://www.valassis.com/digital-advertising) - Brasil | Ribeiro, WA; São Francisco, CA; Lansing, MI; Hamburgo, Alemanha | Tela do telefone, entrevista no local com o grupo, resolução e discussão de problemas do quadro branco emparelhado, projeto take-home e revisão de acompanhamento
  - [Valor](https://www.valuemotive.com/career) | Helsínquia, Finlândia | Exemplos de código de projetos anteriores (trabalho ou hobby) ou exercícios para levar para casa
  - [Professores Varsity](https://www.varsitytutors.com) | Remoto | Leve para casa a tarefa, a apresentação da tarefa, a revisão de código ao vivo com a equipe. Bate-papo avançado / de alto nível com a equipe com base no conjunto de habilidades e função.
  - [Vayu Tecnologia](http://vayu.com.au) | Sydney, Austrália; Catmandu, Nepal | Entrevista curta, perguntas gerais de programação e desafio de levar para casa.
  - [Soluções Vena](https://careers.venasolutions.com) | Toronto, Canadá | Tela do telefone, programação em pares no local e exercício de revisão de código sobre um problema do mundo real
  - [Venminder, Inc.](https://www.venminder.com) | Elizabethtown, KY; Louisville, KY - Brasil | Tela inicial do telefone para explicar a posição. Se o candidato estiver interessado, ele recebe uma tarefa para levar para casa seguida de uma entrevista presencial não roteirizada com os membros da equipe para julgar a adequação da personalidade.
  - [Verloop](https://verloop.io) - Brasil | Bangalore, Índia | Um exercício de programação e discussão técnica
  - [Vernacular.ai](https://vernacular.ai) | Bangalore, Índia | Tela do telefone, Discussão de artigo de pesquisa (ML Role), Revisão de código/Navegação de código aberto/Programação em pares na tela e discussão com CTO/CEO.
  - [Verve](https://verve.co/careers) | Londres, Reino Unido | Um exercício intencionalmente curto que espelha o trabalho real do projeto e incorpora elementos de revisão de código
  - [Verve Proteção Industrial](https://verveindustrial.com/why-verve/careers) | Madison, WI / Remoto | Tela do telefone, discussão do projeto e visão geral da experiência de ferramentas em entrevista de painel com a equipe, problema prático de codificação de editor compartilhado e desafio arquitetônico relevante em entrevista prática
  - [Veteranos United Home Empréstimos](https://www.veteransunited.com/careers/) | Colômbia, MO | Tela do telefone, exercício de programação em pares remoto ou presencial e várias entrevistas presenciais com desenvolvedores e gerentes.
  - [Vingle](https://careers.vingle.net) - Brasil | Seul, Coreia | Entrevista escrita, projeto takehome, revisão de código conversacional presencial e entrevistas com engenheiros e gerentes de engenharia
  - [Vinta Software](https://www.vinta.com.br/careers/) | Recife, Brasil | Entrevista de adequação à cultura, desafio arquitetônico, projeto de levar para casa e emparelhamento sobre amostra de trabalho
  - [virtual7](http://virtual7.de/de/karriere) | Kalrsruhe, Alemanha | Entrevista por telefone e entrevista no local com base na experiência pessoal.
  - [Virtualmente Humano](https://www.vhslab.com) | Remoto | Leve para casa a tarefa, Breve entrevista sobre a tarefa e experiência passada.
  - [Visma e-conomic](https://www.e-conomic.dk/om/job) - Brasil | Copenhaga, Dinamarca | Leve para casa a tarefa, a apresentação da tarefa e a discussão
  - [Vitalidade Sul](https://vitalitysouth.com) | Tupelo, MS - Brasil | Leve para casa projeto, revisão de código e discussão presencial
  - [Voltra Co.](https://voltra.co) | Amsterdã, Holanda / Nova York, NY / Remoto | Mostre-nos sua conta no github, conte-nos o que você sabe. Vamos emparelhar em um OSS PR!
  - [O VSX](https://https://vsx.net/jobs) | Dresden, Alemanha | Entrevista no local, desafio de codificação doméstica, apresentação/discussão de soluções propostas
  - [A VTEX](http://lab.vtex.com/careers) | Rio de Janeiro, Brasil | Projeto levar para casa, entrevista via Skype e depois conversa presencial.
  - [VTS](https://buildingvts.com) - Brasil | Nova Iorque, Nova Iorque | Tela técnica do telefone, programação de pares no local e conversas presenciais com vários engenheiros
  - [Wallapop](https://apply.workable.com/wallapop/) - Brasil | Barcelona, Espanha | Chamada de introdução, projeto técnico OU repositório de tecnologia que você se sente orgulhoso que destaca suas habilidades para o trabalho, entrevista prática e, finalmente, uma entrevista de competência
  - [Marca de caminho](https://waymark.com/jobs) | Detroit, MI - Brasil | Tela técnica do celular, projeto take-home, repassando o projeto pessoalmente, dia de acompanhamento no escritório
  - [Riquezasimples](https://www.wealthsimple.com/work-with-us) | Toronto, Canadá | Par programação em um problema semelhante ao trabalho diário, discussão de design de sistema
  - [WeAreHive - Brasil](http://www.wearehive.co.uk) | Londres, Reino Unido | Basta guiar-nos através do seu melhor código ou nós damos-lhe um pequeno exercício do mundo real para fazer em casa.
  - [Webantic](https://webantic.co.uk/careers) - Brasil | Manchester, Reino Unido | Auto-avaliação básica da TNA e resolução de problemas do mundo real
  - [Fluxo Web](https://webflow.com) | São Francisco, CA & Remoto | Desafio de levar para casa curto, seguido por um projeto de contrato freelance pago de 3-5 dias
  - [Mapas de ervas daninhas](https://weedmaps.com/careers) | Ribeiro, A.C.; Pereira, CO; Ribeiro, AZ; Madri, na Espanha; Remoto | Tela do telefone, entrevista em grupo e possível revisão de código
  - [Wells Fargo (Programa de Tecnologia)](https://www.wellsfargojobs.com/en/university-programs/undergraduate-programs/) | São Francisco, CA; Carlota, Carolina do Norte; Des Moines, IA; Minneapolis, MN; Fênix, AZ; São Luís, MO | Uma rodada, Comportamental + Uma pergunta simples de Design de Sistema + Perguntas para o seu currículo
  - [wemake.serviços](https://wemake.services) | Remoto | Desafio curto não remunerado para levar para casa, revisão de código, discussão de portfólio
  - [WeMod](https://wemod.com) - Brasil | Remoto | Take-home & apresentação / revisão de código, discussão de currículo
  - [Wend](https://www.wend.nl) - Brasil | Amesterdão, Países Baixos | Entrevista face a face seguida de um trabalho para levar para casa
  - [Weploy](https://www.weployapp.com/join-our-team/) - Brasil | Melbourne, Austrália; Sydney, Austrália | Fase 1: Entrevista presencial para conhecer o candidato. Fase 2: Sessão de resolução de problemas que envolve a concepção de uma solução para um problema do mundo real, seguida de 1/2 dia de emparelhamento com um desenvolvedor sênior na implementação da solução proposta.
  - [WeTransfer](https://wetransfer.com/jobs) | Amesterdão, Países Baixos | Cultura fit e fundamentos bate-papo, entrevista de habilidades - sem quadro branco! - e levar para casa projeto, comunicação e colaboração entrevista, reunir-se com o VP de Engenharia
  - [Roda](https://wheely.com/en/careers) | Moscovo, Rússia | Conheçam-se em menos de 30 minutos no local ou via Skype, leve para casa, analise no local e entreviste a equipe.
  - [Fundação Wikimedia](https://wikimediafoundation.org/about/jobs/) | Remoto | Entrevista de fit cultural, cerca de uma hora discutindo possíveis soluções para problemas reais que a equipe que você está se candidatando pode enfrentar. Não respostas certas ou erradas, mais um brainstorming com dois engenheiros que avaliarão como funciona o seu fluxo de trabalho de resolução de problemas.
  - [Windy.com](https://windy.com) | Praga, Chéquia | Falar e escrever um pequeno programa em um computador
  - [A Wirecard Brasil](https://wirecardbrasil.workable.com) | São Paulo, Brasil | Entrevista por telefone ou no local do Cultural Fit, desafio de codificação take-home, revisão de código e discussão pessoalmente.
  - [Wiredcraft](https://wiredcraft.com) | Xangai, China | Entrevista por telefone ou no local, desafio de codificação para levar para casa, revisão de código e discussão pessoalmente.
  - [WorldGaming](https://worldgaming.com) | Toronto, Canadá | Entrevista Técnica, Design de Soluções, Atribuição de Levar para Casa, depois Entrevista de Adequação Cultural com a equipe
  - [WyeWorks](https://wyeworks.com) - Brasil | Montevidéu, Uruguai | Projeto take-home e discussão no local
  - [Equipe X](http://x-team.com) | Remoto | Um desafio Node.js curto e divertido, seguido por uma série de perguntas de entrevista baseadas na cultura, seguidas por um projeto criativo com toneladas de liberdade sobre como abordar e perguntas de acompanhamento sobre a abordagem que escolheram para discutir as compensações. Normalmente, um treinamento pago de 10 a 30 dias é recompensado aos principais candidatos para prepará-los para as habilidades de comunicação remota necessárias para se juntar a uma equipe.
  - [Xebia Segurança](https://xebia.com/careers/security/) | Hilversum, Países Baixos | Culture fit, entrevista técnica, seguida de projeto de segurança take-home, sessão de brainstorm no local para discutir as soluções e abordagem.
  - [XING](https://www.xing.com) - Brasil | Hamburgo, Alemanha | Desafio de codificação take-home, revisão no local e entrevistas curtas com a futura equipe.
  - [Xplor](https://ourxplor.com) - Brasil | Melborne, Austrália; Londres, Reino Unido | Entrevista por telefone Cultural Fit, desafio Take home-code, sessão de programação em pares e discussão sobre experiências passadas

## Y -*



  - [18F](https://18f.gsa.gov/join/) | Remoto; Washington, DC; Nova Iorque, NY; São Paulo, IL; São Francisco, Califórnia | Exercício de codificação para casa (2-4 horas), entrevistas técnicas e de correspondência de valores por videochat
  - [21º Imobiliário](https://21re.de) | Berlim, Alemanha | Chamada telefônica para rápida apresentação pessoal seguida de entrevista por videochamada. Finalmente, uma sessão de programação em pares no local.
  - [23 Tecnologias](https://23technologies.cloud) | Remoto | Três videochamadas: introdução geral, apresentação da equipe, contrato
  - [3BoxLabs](https://3boxlabs.com) - Brasil | Remoto | Chamada de introdução, retomada passo a passo e, finalmente, exercício de trabalho ao vivo com ~2 horas de trabalho indepdendent seguido por ~1,5 horas de debriefing discutindo o trabalho com o resto da equipe.
  - [Hubs 3D](https://3dhubs.com/jobs) | Amesterdão, Países Baixos | Leve para casa o desafio de código do domínio do nosso produto seguido de discussão remota/no local, às vezes faça uma sessão de programação de par no local adicional.
  - [47 Graus](https://47-degrees.breezy.hr) | Remoto; Ribeiro, WA; Madri, ESP; Cádiz, ESP; Londres, Reino Unido | Questões relacionadas à implementação de projetos específicos usando bibliotecas e técnicas de programação funcional populares e uma discussão sobre os tradeoffs. Discussão de projetos/contribuições de código aberto passados e metas futuras de código aberto. **Nota:** Esta empresa procura pessoas que tenham experiência moderna em programação funcional em Haskell, Scala, Swift ou Kotlin e procura pessoas que tenham contribuições de código aberto existentes nesses campos para que as funções possam ser um pouco auto-selecionadas.
  - [4Graus](https://4degrees.ai/about/) | Chicago, Illinois | Exercício colaborativo de programação em pares feito através de bate-papo por vídeo que é representativo das responsabilidades do trabalho e, em seguida, uma tarefa de programação para casa.
  - [500amigos](http://500friends.com/who-we-are/careers) | São Francisco, CA; Remoto | Leve para casa o desafio seguido de expansão no local da submissão e discussões de alto nível (exercício de design ou visão geral de projetos anteriores)
  - [500Tech](https://500Tech.com) - Brasil | Tel Aviv, Israel | Emparelhar a programação em um laptop no trabalho env
  - [5Mentes](https://5minds.de) | Remoto; Gelsenkirchen-Buer, DE - Brasil | Exercício de codificação via GitHub, você é entrevistado por um desenvolvedor e um líder de equipe, não há codificação ao vivo.
  - [8ª Luz](https://8thlight.com) | São Paulo, IL; Londres, Reino Unido; Los Angeles, Califórnia; Nova Iorque, NY | Leve para casa desafio de código, discussão, sessão de programação em pares
  - [YLD - Brasil](https://jobs.lever.co/yld) | Londres, Reino Unido; Lisboa, PT; Porto, PT e remoto | Leve o desafio de código para casa, a sessão de programação em pares e a discussão sobre a experiência passada
  - [Yodas](https://yodas.com) - Brasil | Binyamina, Israel | Codificando tarefas no repositório github
  - [YouGov](https://yougov.com) - Brasil | Remoto; São Francisco, CA; Londres, Reino Unido; Varsóvia, Polônia; Mumbai, Índia; Hong Kong, China | Exercício de codificação às vezes sobre o repositório github, pelo menos 1 entrevista com um desenvolvedor e um lead, sem codificação ao vivo.
  - [Carteira Yoyo](http://yoyowallet.com) | Londres, Reino Unido | Leve para casa o desafio do código, a discussão do desafio do código e as perguntas gerais de alto nível
  - [YunoJuno - Brasil |](http://www.yunojuno.com) Londres, Reino Unido | Desafio de código baseado em uma solicitação de recurso realista em um pacote de código aberto real criado e usado no YunoJuno; entrevista por telefone/vídeo com membros da equipe de Produto para explorar conhecimentos técnicos, experiências, interesses, fit cultural; entrevista in loco, geralmente com Gerente de Produto e CTO.
  - [Grupo ZAP](https://jobs.kenoby.com/grupozap/) | São Paulo, Brasil | Exercício para levar para casa; uma série de entrevistas do mundo real com engenheiros, RH, gerentes de engenharia e gerentes de produto no local.
  - [Zapier](https://zapier.com/jobs/) - Brasil | Remoto | Entrevista com recrutadores, projeto take-home, revisão de código do projeto take-home, discussões técnicas com gerente de contratação e engenheiros da equipe e entrevista de valores.
  - [Zencargo](https://www.zencargo.com/careers) - Brasil | Londres, Reino Unido | Entrevista inicial com o CTO, abordando interesses e expectativas de experiência profissional, seguida de uma entrevista técnica focada em fundamentos e familiaridade com as melhores práticas. Mais um breve bate-papo com os cofundadores para se conhecerem - presencialmente ou remotamente.
  - [Zenefits (Equipe UI)](https://www.zenefits.com/careers) | São Francisco, Califórnia | Uma tela técnica do telefone focada nos fundamentos da JS e/ou um desafio de levar para casa com timebox. O local é uma série de entrevistas projetadas para testar sua compreensão de JS, HTML/CSS, design, etc.
  - [Zensurance](https://www.zensurance.com/careers) | Toronto, Canadá; Remoto | Timeboxed take-home challenge representativo dos tipos de desafios enfrentados no dia-a-dia, e bate-papos via zoom com recrutadores / gerentes de contratação.
  - [Zerodha - Brasil](https://zerodha.com/careers) | Bangalore, Índia | Chamada técnica no início e uma tarefa de programação levar para casa.
  - [Zweitag](https://www.zweitag.de/karriere) - Brasil | Münster, Alemanha & Remote | Chamada de conhecimento, representante de tarefas para nossos problemas, emparelhamento e discussão no local e mentoria durante todo o processo com palestras para alinhamento de expectativas.
  - [Zype](https://www.zype.com/careers#open-positions) - Brasil | Nova Iorque, NY & Remote | Skype/Videochamada com VP de Produto e um desafio para levar para casa.

## Veja também:


  - [Eles me fizeram um quadro branco!](http://they.whiteboarded.me)

[![Node.js IC](https://github.com/poteto/hiring-without-whiteboards/actions/workflows/node.js.yml/badge.svg?branch=master)](https://github.com/poteto/hiring-without-whiteboards/actions/workflows/node.js.yml)
